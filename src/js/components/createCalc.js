...
const createCalc = () => {
    ...
    typeProperty.addEventListener('change', () => {
        ...
        if (name === 'Новостройка') {
            mortOne.removeAttribute('hidden');
            mortTwo.setAttribute('hidden', '');
        } else if (name === 'Вторичка') {
            mortTwo.removeAttribute('hidden');
            mortOne.setAttribute('hidden', '');
        } else {
            mortOne.setAttribute('hidden', '');
            mortTwo.setAttribute('hidden', '');
        }
    ...
    [mortOne, mortTwo].forEach(mort => {
        ...
        const conditions = mort.querySelector('.create-calc-conditions');
        if (conditions) {
            const conditionsCreate = mort.querySelector('.create-calc-conditions__create');
            ...
            function conditionsCreateCancel() {
                ...
                mort.querySelector('.create-calc-conditions__create-body').remove();
            }
