...
//     const input = container.querySelector('[data-upload-drop]');
//     currentImg.remove();
//     input.cstFiles = input.cstFiles.filter(file => file.name !== currentImg.dataset.name)
...
//     const placeSaleImages = container.querySelector('.place-sale-photo__images');
//     if (placeSaleImages) {
//         placeSaleImages.innerHTML = '';
//         let files = input.cstFiles;
//         for (let i = 0; i < files.length; i++) {
//             const file = files[i];
//             const imageURL = window.URL.createObjectURL(file);
//             placeSaleImages.innerHTML += photoGenerate(imageURL, file.name);
...
//             input.cstFiles = [...input.cstFiles, ...Array.from(input.files)]

//             input.cstFiles = input.cstFiles.filter((value, index, self) => {
...
// function photoGenerate(url, name) {
//     const placeSalePhotoHTML = `
//         <div class="place-sale-photo__image ibg drag-drop__item" draggable="true" title="${name}" data-name="${name}">
//             <picture>
//                 <source srcset="${url}" type="image/webp">
//                 <img loading="lazy" src="${url}" width="271" height="190" alt="">
//             </picture>
...
// function pdfGenerate(url, name) {
//     const placeSalePhotoHTML = `
//             <a href="${url}" class="place-sale-photo__image drag-drop__item ibg" draggable="true" target="_blank" title="${name}" data-name="${name}">
//                 <picture>
//                     <source srcset="./img/pdf.webp" type="image/webp">
//                     <img loading="lazy" src="./img/pdf.png" width="271" height="190" alt="">
//                 </picture>
...
// function defaultGenerate(name, input, maxLength) {
//     const placeSalePhotoHTML = `
//     <div class="place-sale-photo__image ibg" title="${name}" data-name="${name}">
//         <div>
//             <svg>
//             <use xlink:href="./img/sprite.svg#save"></use>
//             </svg>
